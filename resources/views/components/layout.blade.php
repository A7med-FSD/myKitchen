...
<body class="pb-20 bg-gray-100 font-family-inter" x-data="{ mobileMenuOpen: false }">
  <div class="px-5 sm:px-10">
    ...
    <div x-show="mobileMenuOpen"
      ...
      <div class="py-4">
        <x-mobile-nav-link href="/" :active="request()->is('/')">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
        ...
        <x-mobile-nav-link href="/orders" :active="request()->is('orders')">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
        ...
        <x-mobile-nav-link href="/menu" :active="request()->is('menu')">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
        ...
        <x-mobile-nav-link href="/inventory" :active="request()->is('inventory')">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
        ...
        <x-mobile-nav-link href="/analytics" :active="request()->is('analytics')">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
        ...
        <x-mobile-nav-link href="/customers" :active="request()->is('customers')">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
        ...
        <x-mobile-nav-link href="/settings" :active="request()->is('settings')">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
