<div x-show="showEditDishModal" 
    ...
    <div x-show="showEditDishModal"
        ...
        <div class="modal-header">
            <h3 class="modal-header-title">Edit Dish</h3>
            <p class="modal-header-subtitle">Update your menu item details</p>
            <button @click="closeEditDishModal()" class="modal-close">
